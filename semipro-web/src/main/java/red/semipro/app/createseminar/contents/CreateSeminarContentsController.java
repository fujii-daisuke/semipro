...
@TransactionTokenCheck(value = "createSeminarContents")
@RequiredArgsConstructor
public class CreateSeminarContentsController {

    private final CreateSeminarContentsHelper createSeminarContentsHelper;
    ...
    public ModelAndView input(@AuthenticationPrincipal final AccountUserDetails accountUserDetails,
        ...
        CreateSeminarContentsForm form =
            createSeminarContentsHelper
                .setupForm(seminarId, accountUserDetails.getAccount().getId());

        model.addObject("contentsForm", form);
        model.setViewName("createseminar/contentsForm");
        return model;
    }
    ...
    public ModelAndView save(@AuthenticationPrincipal AccountUserDetails accountUserDetails,
        ...
        @ModelAttribute("contentsForm") @Validated CreateSeminarContentsForm form,
        BindingResult result,
        ModelAndView model) throws IllegalAccessException {

        if (!Objects.equals(seminarId, form.getSeminarId())) {
            model.setViewName("redirect:/seminars/create/" + form.getSeminarId() + "/contents");
            return model;
        }
        ...
        createSeminarContentsHelper.save(form, accountUserDetails.getAccount().getId());
