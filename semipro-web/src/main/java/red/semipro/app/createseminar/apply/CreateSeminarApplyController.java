...
public class CreateSeminarApplyController {

    private final CreateSeminarApplyHelper createSeminarApplyHelper;
    ...
    public ResponseEntity apply(@AuthenticationPrincipal AccountUserDetails accountUserDetails,
        ...
        try {
            bindingResult = createSeminarApplyHelper.apply(seminarId, accountUserDetails.getAccount().getId());
