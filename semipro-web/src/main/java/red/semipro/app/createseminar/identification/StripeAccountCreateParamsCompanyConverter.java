...
public class StripeAccountCreateParamsCompanyConverter {
     ...
     * @return Stripe法人
     */
    public AccountCreateParams.Company convert(@NotNull final CompanyForm form,
     ...
     */
    private AccountCreateParams.Company.AddressKanji convert(
        @NotNull final AddressForm form) {
        return AccountCreateParams.Company.AddressKanji.builder()
     ...
     */
    private AccountCreateParams.Company.AddressKana convert(
        @NotNull final AddressKanaForm form) {
        return AccountCreateParams.Company.AddressKana.builder()
            .setPostalCode(form.getPostalCode())
            .setState(form.getState())
            .setCity(form.getCity())
            .setTown(form.getTown())
