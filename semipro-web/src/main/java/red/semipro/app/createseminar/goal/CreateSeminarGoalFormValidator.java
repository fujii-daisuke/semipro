...
public class CreateSeminarGoalFormValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return (CreateSeminarGoalForm.class).isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {

        CreateSeminarGoalForm form = (CreateSeminarGoalForm) target;
