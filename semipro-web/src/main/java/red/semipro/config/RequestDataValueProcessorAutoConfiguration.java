...
public class RequestDataValueProcessorAutoConfiguration {
    ...
    RequestDataValueProcessor requestDataValueProcessor() {
        CompositeRequestDataValueProcessor compositeRequestDataValueProcessor = new CompositeRequestDataValueProcessor(new CsrfRequestDataValueProcessor(),
        ...
        return new RequestDataValueProcessor() {
            ...
            public String processFormFieldValue(HttpServletRequest request, String name, String value, String type) {
                return compositeRequestDataValueProcessor.processFormFieldValue(request, name, value, type);
            }
            
            @Override
            public String processAction(HttpServletRequest request, String action, String httpMethod) {
                return compositeRequestDataValueProcessor.processAction(request, action, httpMethod);
            }
